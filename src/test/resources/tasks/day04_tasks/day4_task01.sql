...
select e.FIRST_NAME, j.JOB_TITLE, DEPARTMENT_NAME, CITY
from EMPLOYEES e
         left join JOBS j
                   on e.JOB_ID = j.JOB_ID
...
-- 8. FIND OUT EMPLOYEES , JOB_TITLE , DEPARTMENT_NAME , CITY , COUNTRY_NAME , REGION_NAME
select e.FIRST_NAME, JOB_TITLE, DEPARTMENT_NAME, CITY, COUNTRY_NAME, REGION_NAME
from EMPLOYEES e
    left join JOBS j
        on e.JOB_ID = j.JOB_ID
    left join DEPARTMENTS d
...
select DEPARTMENT_NAME, l.LOCATION_ID, c.COUNTRY_ID
from DEPARTMENTS d
...
select DEPARTMENT_NAME, d.LOCATION_ID, c.COUNTRY_NAME
from LOCATIONS l
